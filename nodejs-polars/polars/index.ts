...
import * as debug from "./internals/polars_internal.js";
...
import type { FillNullStrategy as _FillNullStrategy } from "./utils.js";
...
export type LazyGroupBy = lazy.GroupBy;
export type When = lazy.when.When;
export type WhenThen = lazy.when.WhenThen;
export type WhenThenThen = lazy.when.WhenThenThen;
...
export import when = lazy.when.when;
